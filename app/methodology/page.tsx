...
export const metadata: Metadata = {
  title: 'Metodología - Cómo detectamos sobreprecios | RindeChile',
  description:
    'Metodología estadística para la detección de sobreprecios en compras municipales en Chile. Rango esperado, IQR, filtros de calidad y limitaciones.',
  alternates: {
    canonical: 'https://rindechile.cl/methodology',
  },
  openGraph: {
    title: 'Metodología - Cómo detectamos sobreprecios | RindeChile',
    description:
      'Metodología estadística para la detección de sobreprecios en compras municipales en Chile.',
    url: 'https://rindechile.cl/methodology',
    type: 'article',
  },
};
...
const articleJsonLd = {
  ...
  '@type': 'Article',
  headline: 'Cómo detectamos sobreprecios en compras municipales',
  description:
    'Metodología estadística para la detección de sobreprecios en compras municipales en Chile.',
  author: {
    '@type': 'Organization',
  ...
  publisher: {
    ...
    logo: {
      '@type': 'ImageObject',
      url: 'https://rindechile.cl/logo-full.svg',
    },
  },
  mainEntityOfPage: 'https://rindechile.cl/methodology',
  inLanguage: 'es',
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Metodología',
      item: 'https://rindechile.cl/methodology',
    },
  ],
};
